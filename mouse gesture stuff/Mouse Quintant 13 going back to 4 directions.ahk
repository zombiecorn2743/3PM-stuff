...
;If ErrorLevel {
	...
	While GetKeyState(LTrim(A_ThisHotkey,"~"), "P"){
        ...
        RMG := StrReplace(UMG, "R", " + Right")
        ;EMG := StrReplace(RMG, "E", " + East")
        DMG := StrReplace(RMG, "D", " + Down")
        ;SMG := StrReplace(DMG, "S", " + South")
        LMG := StrReplace(DMG, "L", " + Left")
...
R() {
    ...
    ;Sleep, 800
	;btt()​
    global FunctionName := "ESCRITORIO SIGUIENTE"
...
L() {
    ...
    ;Sleep, 800
	;btt()​
    global FunctionName := "ESCRITORIO ANTERIOR"
...
U() {
    ...
    ;Sleep, 800
	;btt()​
    global FunctionName := "ESCRITORIO ARRIBA"
...
D() {
    ...
    ;Sleep, 800
	;btt()​
    global FunctionName := "ESCRITORIO ABAJO"
...
GetGestureName(x) {
    if (x == "Up + Down") {
        ...
        GestureName := "`nESCRITORIO ARRIBA"
    }
    else if (x == "Right") {
        GestureName := "`nESCRITORIO SIGUIENTE"
    }
    else if (x == "Down") {
        GestureName := "`nESCRITORIO ABAJO"
    }
    else if (x == "Left") {
        GestureName := "`nESCRITORIO ANTERIOR"
    }
    else if (x == ""){
        GestureName := "`nRight-click down"
    }
    else {
        ;GN := " NADA"
        GestureName := "`nNADA"
