...
XButton2::		;gesture hotkey, i imagine most would use a mousekey for gestures,ctrl is simply an example suitable for testing as i've got radial menu running...
...
R() {
    Send, +{f2} ;{Media_Next} ;^!+{Right}
	;btt("ESCRITORIO SIGUIENTE",,,, "Style1")
    ;Sleep, 800
	;btt()​
    global FunctionName := "ALTERNAR PESTAÑA" ;"ESCRITORIO SIGUIENTE"
...
L() {
    Send, {f8} ;{Media_Prev} ;^!+{Left}
	;btt("ESCRITORIO ANTERIOR",,,, "Style1")
    ;Sleep, 800
	;btt()​
    global FunctionName := "BARRA DE LADO" ;"ESCRITORIO ANTERIOR"
...
U() {
    ...
    ;Sleep, 800
	;btt()​
    global FunctionName := "PESTAÑA ACTIVA ANTERIOR"
...
D() {
    ...
    ;Sleep, 800
	;btt()​
    global FunctionName := "PESTAÑA ACTIVA SIGUIENTE"
...
UR() {
    ...
    ;Sleep, 800
	;btt()​
    global FunctionName := "NUEVA PESTAÑA"
...
DU() {
    ...
    ;Sleep, 800
	;btt()​
    global FunctionName := "CERRAR PESTAÑA"
...
GetGestureName(x) {
    if (x == "Up + Down") {
        ...
        GestureName := "`nCERRAR PESTAÑA"
    }
    else if (x == "Up") {
        GestureName := "`nPESTAÑA ACTIVA ANTERIOR"
    }
    else if (x == "Right") {
        GestureName := "`nALTERNAR PESTAÑA"
    }
    else if (x == "Down") {
        GestureName := "`nPESTAÑA ACTIVA SIGUIENTE"
    }
    else if (x == "Left") {
        GestureName := "`nBARRA DE LADO"
    }
    else if (x == ""){
